...
$select = "SELECT * FROM feature_image";
					...
					<tbody>
						<?php foreach($select_result as $tb => $result){ ?>
							<tr>
								...
								<td><a href="edit_feature_image.php?id=<?= $result['id']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a></td>
								<td><a href="delete_feature_image.php?id=<?= $result['id']; ?>" class="btn btn-danger"><i class='fas fa-trash-alt'></i></a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
