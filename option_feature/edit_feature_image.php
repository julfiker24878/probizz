...
$id = $_GET['id']; 
$select = "SELECT * FROM feature_image WHERE id=$id";
...
<div class="row">
	<div class="col-md-8 m-auto">
		<div class="card">
			...
			<!-- CARD BODY -->
			<div class="card-body">
				<form action="update_feature_image.php" method="POST" enctype="multipart/form-data">
					...
					<div class="mb-3">
						<label for="img" class="form-label">Feature Image</label>
						<img src="uploaded/<?= $after_assoc['image']; ?>" width="70" class="img-fluid mb-3">
