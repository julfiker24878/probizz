	...
	<div class="col-md-8 m-auto">
		<div class="card">
			...
			<div class="card-header bg-primary">
				<h2 style="color: #fff; font-family: 'Montserrat', sans-serif;">Add Feature Image</h2>
			</div>
			<!-- CARD BODY -->
			<div class="card-body">
				<form action="feature_image_post.php" method="POST" enctype="multipart/form-data">
