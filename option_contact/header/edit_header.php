...
$id = $_GET['id']; 
$select = "SELECT * FROM contact_header WHERE id=$id";
	...
	<div class="col-md-8 m-auto">
		<div class="card">
			...
			<div class="card-header">
				<h2>Edit Header Content of Contact Section</h2>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="mb-3"><!-- TITLE BLUE -->
								<label for="title_blue" class="form-label">Title Second Part Blue</label>
