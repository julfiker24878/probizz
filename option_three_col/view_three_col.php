					...
					<tbody>
						<?php foreach($select_result as $ts => $result){ ?>
							<tr>
								...
								<td style="text-transform: uppercase;"><?= $result['title_red']; ?></td>
								<td style="text-transform: uppercase;"><?= $result['title_blue']; ?></td>
								<td><?= $result['des']; ?></td>
								<td>
								...
								<td><a href="edit_three_col.php?id=<?= $result['id']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a></td>
								<td><a href="delete_three_col.php?id=<?= $result['id']; ?>" class="btn btn-danger"><i class='fas fa-trash-alt'></i></a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
